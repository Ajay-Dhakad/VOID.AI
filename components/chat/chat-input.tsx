  ...
  {isListening ? (
    ...
    <Mic className="w-4 h-4 text-slate-600 dark:text-slate-300" />
      ...
      <p className="text-xs text-slate-600 dark:text-slate-400 mt-3 text-center font-medium">
        Press <kbd className="px-2 py-1 bg-slate-200 dark:bg-slate-700 rounded text-xs font-mono">Enter</kbd> to send •
        AI-powered responses • Image generation available
      </p>
    </div>
  )
})
